...
bool display_player_round_score(int round_num, int player, bool break_cycle, char **player_scores, int **player_round_score, int **player_total); 
...
void extra_round(int &round_num, int num_players, int &player, int spin_total, char **&player_scores, int **&player_round_score, int **&player_total, char **player_name) {
   ...
   for (int i = 0; i < num_players; i++) {
	 ...
	 spin_for_bowl(player, round3, num_players, player_scores, player_total, player_round_score, spin_total, strike, spare);
...
bool display_player_round_score(int round_num, int player, bool break_cycle, char **player_scores, int **player_round_score, int **player_total) {
   ...
   if (display_player_round_score(--round_num, player, break_cycle, player_scores, player_round_score, player_total) && break_cycle) {
...
void scoresheet(char **&player_name, char **&player_scores, int **&player_total, int **&player_round_score, int num_players, int round_num, int player) {
   ...
   for (int i = 0; i < num_players; i++) {
	 ...
	 cout << " |  " << player_scores[i][2*j] << " " << player_scores[i][2*j+1]; 
      ...
      if ( (player_scores[i][20] != 'X' && player_scores[i][20] == ' ' && player_scores[i][21] == ' ') ) {

	 if (i+1 <= player && round_num != 10 && round_num != 11)
	    display_player_round_score(round_num, i + 1, break_cycle, player_scores, player_round_score, player_total); 
	 else if (round_num == 0)
	    ;
	 else
	    display_player_round_score(round_num - 1, i + 1, break_cycle, player_scores, player_round_score, player_total); 
      }
